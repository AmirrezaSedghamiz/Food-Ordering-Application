  ...
  Future<void> _loadOrders(int pageNumber) async {
    ...
    try {
      List<ItemOrderManager>? fetchedOrders =
          await ItemOrderManager.nonPendingOrdersManager(
                        ...
                        return Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              const Divider(color: Color(0xFFF8F3F0), thickness: 0.5,),
                              const SizedBox(height: 4.0),
                              Text(
                              ...
                              const SizedBox(height: 8.0),
                              Text(
                                orders[index].order.status == OrderStatus.ACCEPTED ?'تایید شده':'رد شده',
                                style: TextStyle(
                                    fontSize: 16.0,
                                    color: orders[index].order.status == OrderStatus.ACCEPTED ?const Color(0xFF5CB338) :const Color(0xFFFB4141) ,
                                    fontFamily: "DanaFaNum"),
                              ),
                            ],
                          ),
